    ...
    handler: () => {
      window.location.href = "/portfolio/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/portfolio/projects/1_afmpdt_halbach/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/portfolio/projects/2_titan_abep/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/portfolio/projects/3_zinc_hall_thruster/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/portfolio/projects/4_electret_ion_thruster/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/portfolio/projects/5_jaxa_trajectory/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/portfolio/projects/6_cubesat_platform/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/portfolio/projects/7_tactical_cv_engine/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/portfolio/projects/template_project.md/";
            },},{
      id: 'light-theme',
